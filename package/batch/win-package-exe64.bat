...
echo ... copy exe ...
xcopy /Y %cd%\..\..\bin\oscilloscope64r.exe  %cd%\..\..\package\scopefun-win\bin
ren %cd%\..\..\package\scopefun-win\bin\oscilloscope64r.exe oscilloscope.exe

echo ... package ...
compil32 /cc "%cd%\..\..\package\scopefun-win\innosetup.iss"

del /Q %cd%\..\scopefun-win64.exe
ren %cd%\..\scopefun-win.exe scopefun-win64.exe
